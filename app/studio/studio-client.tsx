...
import { ArrowDown, ArrowRight, ArrowUp, BarChart3, BookOpen, Check, Eye, Heart, LogIn, Plus, Radio, Sparkles, Users, Zap } from "lucide-react";
...
export function StudioClient() {
  ...
  useEffect(() => {
    ...
    fetch("/api/community", { cache: "no-store" }).then((response) => response.ok ? response.json() : null).then((data) => {
      const payload = data as { signedIn?: boolean; isFounder?: boolean; ownedProducts?: StudioProduct[]; wallet?: Wallet | null } | null;
